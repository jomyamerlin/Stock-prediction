...
# Set variables
TICKERS = ['META', 'GOOG', "AMZN", "NVDA", "TSLA", "AAPL", "QCOM", "PFE", "GME", "NOW", "AMD", "SAVE", "MSFT", "MA", "SNAP", "FSLR", "BWV", "MARA"]
...
def load_historic_data_into_postgres(ticker, ti):
    ...
    # Define Postgres hook Create connection
...
def create_dag(ticker, default_args):
    dag = DAG(
        ...
        schedule_interval='*/30 8-21 * * 1-5',
        catchup=False,
        tags=['finance', 'options',"stock", ticker]
    )
